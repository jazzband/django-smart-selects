...
Keep in mind that this AJAX query exposes your data (only the models with chained fields) to all users who can access it. If you would like more control over this permission, the [`django-autocomplete-light`](https://github.com/yourlabs/django-autocomplete-light) package is a great, high-quality package that enables the same functionality with permission checks.
